...
export default function Home() {
  return (
    <main className="max-h-screen overflow-y-auto bg-gray-100 p-6">
      {/* Hero Section */}
      <section className="bg-white p-10 rounded-2xl shadow-md text-center mb-10">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Find internships and job opportunities for USC students.
        </p>
      ...
      <section className="grid md:grid-cols-3 gap-6">
        {[
          ...
          { title: "Full-Time Jobs", href: "/fulltime" },
          { title: "Part-Time Jobs", href: "/parttime" },
